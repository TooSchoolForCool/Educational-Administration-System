...
public class JPanel_Stu_Exam_QueryInfo extends JPanel implements ActionListener{
	private JTextField oripassword;
	private JTextField newpassword;
	private JTextField newpassword2;
	
	public JPanel_Stu_Exam_QueryInfo(String name){
		init(name);
	...
	public void init(String name){
		...
		JLabel label = new JLabel("查询考试信息界面");
